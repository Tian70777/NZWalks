    ...
    public class NZWalksDbContext : DbContext
    {
        ...
        */
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // seed data for Difficilties: easy, medium, hard   
            // create a new list, then seed the list to the database

            // Guid.NewGuid() is a method that generates a new unique identifier
            // cannot use new each time, cuz it will create new id each time code runs
            // need to create 3 identifiers for difficulties
            // view -> other windows -> c# interactive -> generate 3 times, Guid.NewGuid()
            // then copy the Guid.NewGuid() to the Id field
            ...
            // add region data, seed data for regions
